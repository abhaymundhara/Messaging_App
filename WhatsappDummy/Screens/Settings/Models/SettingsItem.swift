...
extension SettingsItem {
    static let avatar = SettingsItem(imageName: "photo", backgroundColor: .blue, title: "Change Profile Picture")
    ...
    static let SignOut = SettingsItem(imageName: "power", backgroundColor: .red, title: "Log Out")
    
}

extension SettingsItem {
    static let media = SettingsItem(imageName: "photo", backgroundColor: .blue, title: "Media, Links & Docs")
    
    static let mute = SettingsItem(imageName: "speaker.wave.2.fill", backgroundColor: .green, title: "Mute")
    
    static let wallpaper = SettingsItem(imageName: "circles.hexagongrid", backgroundColor: .mint, title: "Wallpaper & Sound")
    ...
    static let lockChat = SettingsItem(imageName: "lock.doc.fill", backgroundColor: .blue, title: "Lock Chat")
